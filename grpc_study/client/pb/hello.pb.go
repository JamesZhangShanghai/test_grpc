...
func (*ClientStream) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{2} }
...
func (*ServerStream) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{3} }
...
func (c *helloServiceClient) Chat(ctx context.Context, opts ...grpc.CallOption) (HelloService_ChatClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_HelloService_serviceDesc.Streams[0], c.cc, "/pb.HelloService/Chat", opts...)
	if err != nil {
		return nil, err
	}
